...
const arrayOfPeople = [
  {
    name: "Bede",
    age: 27,
    favoriteFoods: ["beans", "garri"]
  },
  {
    name: "Chidi",
    age: 47,
    favoriteFoods: ["vanilla", "Bread"]
  },
  {
    name: "Marshal",
    age: 37,
...
const personName = "Bede";
var findPeopleByName = async function(personName, done) {
  await Person.find({ name: personName }, (error, data) => {
    if (error) {
      console.log(error);
    } else {
      console.log(data);
...
// const personId = 'awDretgh257763lkjf'
